...
root = os.path.normpath("/home/pi/Desktop/cptr-435-final-project/Pictures")
key = ""
...
if __name__ == '__main__':
    ...
    root = os.path.normpath(os.getenv('FS_PATH', '/home/pi/Desktop/cptr-435-final-project/Pictures'))
